...
<div class="profilees">
   ...
   ?>
   <h3><?php echo $fetch['Companyname']; ?></h3>
...
.containeres .profilees h3 {
    margin: 5px 0;
    font-size: 20px;
    color: var(--black);
}

.containeres .profilees p {
    margin-top: 20px;
    color: var(--black);
    font-size: 20px;
}
        ...
        <div class="header-main">
            ...
            <div class="container">
                ...
                <a href="#" class="header-logo">
                    <img src="./assets/images/new cart.png" alt="Anon's logo" width="12" height="3">
                </a>
